...
namespace Sam3d {
	...
	public:
		...
		virtual const Vector3df& getNormal(uInt i) const = 0;

		//! returns normal of vertex i
		virtual core::vector3df& gtNormal(uInt i) = 0;

		//! returns texture coord of vertex i
		virtual const core::vector2df& getTCoords(uInt i) const = 0;

		//! returns texture coord of vertex i
		virtual vector2df& getTCoords(uInt i) = 0;
